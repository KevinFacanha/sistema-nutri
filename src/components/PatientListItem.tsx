...
export const PatientListItem: React.FC<PatientListItemProps> = ({ patient, onEdit, onDelete }) => {
        ...
        <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-2">
              <h3 className="font-semibold text-gray-800 truncate text-sm sm:text-base">👤 {patient.name}</h3>
            ...
            <div className="space-y-1 text-xs sm:text-sm text-gray-600">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="truncate">📅 Última consulta: {formatDate(patient.last_consultation)}</span>
              </div>
            </div>
          </div>
        </div>
