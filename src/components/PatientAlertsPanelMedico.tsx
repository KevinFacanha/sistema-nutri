...
interface PatientAlertsPanelMedicoProps {
  patients: PatientMedico[];
  onViewAllOverdue: () => void;
  onMarkAsContacted: (patientId: string, milestone: number) => Promise<void>;
}

export const PatientAlertsPanelMedico: React.FC<PatientAlertsPanelMedicoProps> = ({ 
  patients, 
  onViewAllOverdue,
  onMarkAsContacted
}) => {
  ...
  const shouldShowInAlerts = (patient: PatientMedico): boolean => {
        ...
        <div className="border-t border-gray-200 p-4 space-y-4">
          ...
          <div className="flex items-start gap-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <p className="text-sm text-blue-800">
              Esses pacientes estão há mais tempo sem retornar. Acompanhe-os de perto para manter o plano de tratamento eficiente.
            </p>
          </div>
