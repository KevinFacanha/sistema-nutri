...
import { PatientListItemMedico } from './PatientListItemMedico';
import { PatientMedico } from '../types';

interface PatientListMedicoProps {
  patients: PatientMedico[];
  loading: boolean;
  onEdit: (patient: PatientMedico) => void;
  onDelete: (id: string) => void;
  onAddNew: () => void;
}

export const PatientListMedico: React.FC<PatientListMedicoProps> = ({
  patients,
  loading,
  onEdit,
  onDelete,
  ...
  const filteredAndSearchedPatients = useMemo(() => {
    ...
    return filtered.sort((a, b) => {
      const daysA = getDaysSinceConsultation(a.data_consulta);
      const daysB = getDaysSinceConsultation(b.data_consulta);
      return daysA - daysB;
    });
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-lg sm:text-xl font-semibold text-gray-800">Pacientes do Médico</h2>
